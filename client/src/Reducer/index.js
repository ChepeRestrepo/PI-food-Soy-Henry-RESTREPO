...
function rootReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case "FILTER_BY_DIET":
      ...
      const statusFilter = allRecipe.filter((el) =>
    ...
    case "ORDEN_BY_SCORE":
      ...
      return {
        ...
        axu: state.recipes,
        recipes:
          action.payload === "default" ? state.allRecipes : orderedRecipes2,
      };
    case "CLEAN_DETAIL":
      return {
        ...state,
    ...
    case "SEARCH_BAR":
      ...
      resultSearch = resultSearch.filter((el) =>
    ...
    case "ADD_FAVORITE":
      const filterFavorite = state.allRecipes.filter(
